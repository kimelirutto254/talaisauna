...
<body>
    <nav class="navbar navbar-expand-lg glass-card mx-3 mt-3 p-3">
        <div class="container-fluid">
            <a class="navbar-brand nav-brand-text" href="<?php echo e(route('home')); ?>">Talai Herbal Sauna</a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav align-items-center gap-3">
                    <?php if(auth()->guard()->check()): ?>
                        <li class="nav-item">
                            <span class="text-white-50 me-2">Welcome, <?php echo e(auth()->user()->name); ?></span>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-sauna btn-sm">Dashboard</a>
                        </li>
                        <li class="nav-item">
    ...
    <footer class="text-center py-4 text-white-50">
        <div class="container">
            &copy; <?php echo e(date('Y')); ?> Talai Herbal Sauna. Providing relaxation at Nairobi & Kapsabet.
        </div>
    </footer>
...
<?php /**PATH /Users/dismas/Desktop/businessmanager/resources/views/layouts/app.blade.php ENDPATH**/ ?>