...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold mb-0"><?php echo e($branch->name); ?></h2>
        <p class="text-muted"><?php echo e($branch->location); ?> - Manager Dashboard</p>
    </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $activeSessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div><?php echo e($session->customer?->name ?? 'Walk-in'); ?></div>
                                    <small class="text-muted"><?php echo e($session->customer?->phone); ?></small>
                                </td>
                                <td><?php echo e($session->sauna->name); ?></td>
                                <td>
                                    <?php if($minutesLeft > 0): ?>
                                        <span class="text-success"><?php echo e($minutesLeft); ?> min left</span>
                                    <?php else: ?>
                                        <span class="text-danger fw-bold"><?php echo e(abs($minutesLeft)); ?> min overdue</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($session->payments->sum('amount') >= $session->sauna->price): ?>
                                ...
                                <td class="text-end">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#paymentModal<?php echo e($session->id); ?>">
                                                    <i class="bi bi-cash me-2"></i> Record Payment
                                                </button>
                                            </li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li>
                                                <form action="<?php echo e(route('sessions.checkout', $session->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal fade" id="paymentModal<?php echo e($session->id); ?>" tabindex="-1">
                                        <div class="modal-dialog modal-sm modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h6 class="modal-title">Payment #<?php echo e($session->id); ?></h6>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                                </div>
                                                <form action="<?php echo e(route('sessions.pay', $session->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="modal-body text-start">
                                                        <div class="mb-2">
                                                            <label class="small text-muted">Amount Due</label>
                                                            <input type="number" name="amount" class="form-control" value="<?php echo e(max(0, $session->sauna->price - $session->payments->sum('amount'))); ?>">
                                                        </div>
                                                        <div class="mb-2">
        ...
        <div class="glass-card">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $transactions->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-4"><?php echo e($trx->date->format('M d')); ?></td>
                                ...
                                <td class="text-end pe-4 fw-bold <?php echo e($trx->type == 'income' ? 'text-success' : 'text-danger'); ?>">
                                    <?php echo e(number_format($trx->amount)); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="sauna_id" id="saunaSelect" class="form-select" required onchange="updatePricingRules()">
                            ...
                            <?php $__currentLoopData = $saunas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sauna): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($sauna->id); ?>" 
                                    data-default-price="<?php echo e($sauna->price); ?>"
                                    data-default-duration="<?php echo e($sauna->session_duration); ?>"
                                    data-rules="<?php echo e(json_encode($sauna->pricingRules)); ?>">
                                    <?php echo e($sauna->name); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/dismas/Desktop/businessmanager/resources/views/dashboard/branch.blade.php ENDPATH**/ ?>