    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <img src="{{ asset('logo.png') }}" alt="Talai Herbal Sauna Logo" style="height: 60px; width: 60px;">
            ...
            <div class="text-center">
                ...
                <small><a href="{{ route('login') }}" class="text-decoration-none opacity-50" style="color: var(--text-light);">Staff Portal</a></small>
            </div>
        </div>
    </footer>
