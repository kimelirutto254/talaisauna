...
<div id="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="nav flex-column gap-2 mt-2">
            ...
            <li class="nav-item">
                <a href="{{ route('pricing-rules.index') }}" class="nav-link {{ request()->routeIs('pricing-rules.*') ? 'active' : '' }}">
        ...
        <div class="mt-auto p-4 border-top border-light border-opacity-10 position-absolute bottom-0 w-100">
            <div class="d-flex align-items-center gap-3 mb-3">
                ...
                <div style="line-height: 1.2;">
                    ...
                    <small class="text-muted" style="font-size: 0.8rem;">{{ ucfirst(auth()->user()->role) }}</small>
                </div>
            </div>
